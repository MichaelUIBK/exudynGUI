...
class AutoGeneratedForm(QDialog):
    ...
    def onPreviewClicked(self):
        ...
        try:
            ...
            # ✅ Mark this as a preview call to allow data collection even with name conflicts
    ...
    def createFieldWidget(self, fieldName, meta, userVariables=None):
        ...
        if any(substr in fieldType for substr in ("vector", "list")):
            ...
            if defaultValue not in ("", None):
                ...
                # ✅ Store default value to avoid closure issues
                line._defaultValue = str(defaultValue)
                line._hasDefaultValue = True

                def on_focus_safe(event):
                    # ✅ Safely clear the gray default when user clicks into the box
                ...
                # ✅ Use a proper method override instead of lambda
    ...
    def collectAndNormalizeData(self):
        ...
        if name.lower() in existing_names_set:
            ...
            # ✅ For preview, still return the data but flag the error
            ...
            if hasattr(self, '_isPreview') or 'preview' in str(getattr(self, '_caller', '')).lower():
                debugLog(f"[collectAndNormalizeData] ⚠️ Preview mode: returning data despite name collision")
